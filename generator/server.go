...
func (g *generator) genBuildRequestMethod(serviceName string, method methodParams) error {
	...
	if len(method.inputFieldList) != 0 {
		switch *g.cfg.Library {
		case libraryNetHTTP:
			g.gf.P("for key, value := range r.URL.Query() {")
		case libraryFastHTTP:
...
func (g *generator) genQueryArgCheck(f field) (err error) {
	...
	switch f.kind {
	case protoreflect.Int32Kind, protoreflect.Sint32Kind, protoreflect.Uint32Kind, protoreflect.Sfixed32Kind, protoreflect.Fixed32Kind:
		g.gf.P("	"+f.goName, "Str := value")
		g.gf.P("	", f.goName, ", convErr := ", strconvPackage.Ident("ParseInt"), "(", f.goName, "Str[0], 10, 32)")
		g.gf.P("	if convErr != nil {")
		g.gf.P("		err = ", fmtPackage.Ident("Errorf"), "(\"conversion failed for parameter ", f.protoName, ": %w\", convErr)")
		g.gf.P("		return")
		g.gf.P("	}")
	...
	case protoreflect.Int64Kind, protoreflect.Sint64Kind, protoreflect.Sfixed64Kind:
		g.gf.P("	"+f.goName, "Str := value")
		g.gf.P("	", f.goName, "Value, convErr := ", strconvPackage.Ident("ParseInt"), "(", f.goName, "Str[0], 10, 64)")
		g.gf.P("	if convErr != nil {")
		g.gf.P("		err = ", fmtPackage.Ident("Errorf"), "(\"conversion failed for parameter ", f.protoName, ": %w\", convErr)")
		g.gf.P("		return")
		g.gf.P("	}")
	...
	case protoreflect.Uint64Kind, protoreflect.Fixed64Kind:
		g.gf.P("	"+f.goName, "Str := value")
		g.gf.P("	", f.goName, ", convErr := ", strconvPackage.Ident("ParseInt"), "(", f.goName, "Str[0], 10, 64)")
		g.gf.P("	if convErr != nil {")
		g.gf.P("		err = ", fmtPackage.Ident("Errorf"), "(\"conversion failed for parameter ", f.protoName, ": %w\", convErr)")
		g.gf.P("		return")
		g.gf.P("	}")
	...
	case protoreflect.DoubleKind:
		g.gf.P("	"+f.goName, "Str := value")
		g.gf.P("	", f.goName, "Value, convErr := ", strconvPackage.Ident("ParseFloat"), "(", f.goName, "Str[0], 64)")
		g.gf.P("	if convErr != nil {")
		g.gf.P("		err = ", fmtPackage.Ident("Errorf"), "(\"conversion failed for parameter ", f.protoName, ": %w\", convErr)")
		g.gf.P("		return")
		g.gf.P("	}")
	...
	case protoreflect.FloatKind:
		g.gf.P("	"+f.goName, "Str := value")
		g.gf.P("	", f.goName, ", convErr := ", strconvPackage.Ident("ParseFloat"), "(", f.goName, "Str[0], 32)")
		g.gf.P("	if convErr != nil {")
		g.gf.P("		err = ", fmtPackage.Ident("Errorf"), "(\"conversion failed for parameter ", f.protoName, ": %w\", convErr)")
		g.gf.P("		return")
		g.gf.P("	}")
		...
		g.gf.P("	arg.", f.goName, " = ", reference, f.goName, "Value")
	case protoreflect.StringKind:
		g.gf.P("	" + f.goName + "Value := value")
		g.gf.P("	arg.", f.goName, " = ", reference, f.goName, "Value[0]")
	case protoreflect.BytesKind:
		g.gf.P("	arg." + f.goName + " = []byte(value[0])")
	case protoreflect.BoolKind:
		g.gf.P("	"+f.goName, "Str := value")
		g.gf.P("	switch ", f.goName, "Str[0] {")
		g.gf.P("	case \"true\", \"t\", \"1\":")
		...
		g.gf.P("		arg."+f.goName+" = ", reference, f.goName, "Value")
		g.gf.P("	default:")
		g.gf.P("		err = ", fmtPackage.Ident("Errorf"), "(\"unknown bool string value %s\", ", f.goName, "Str[0])")
		g.gf.P("		return")
		g.gf.P("	}")
	case protoreflect.EnumKind:
		g.gf.P("	"+f.goName, "Str := value")
		g.gf.P("	if ", f.enumName, "Value, optValueOk := ", f.enumName, "_value[", stringsPackage.Ident("ToUpper"), "(", f.goName, "Str[0])]; optValueOk {")
		g.gf.P("		", f.goName, f.enumName, "Value := ", f.enumName, "(", f.enumName, "Value)")
		g.gf.P("		arg.", f.goName, " = ", reference, f.goName, f.enumName, "Value")
		g.gf.P("	} else {")
		g.gf.P("		if intOptionValue, convErr := ", strconvPackage.Ident("ParseInt"), "(", f.goName, "Str[0], 10, 32); convErr == nil {")
		g.gf.P("			if _, optIntValueOk := ", f.enumName, "_name[int32(intOptionValue)]; optIntValueOk {")
		g.gf.P("				", f.goName, f.enumName, "Value := ", f.enumName, "(intOptionValue)")
		g.gf.P("				arg.", f.goName, " = ", reference, f.goName, f.enumName, "Value")
		g.gf.P("			}")
		g.gf.P("		}")
		g.gf.P("	}")
...
func (g *generator) genRepeatedQueryArgCheck(f field) error {
	switch f.kind {
	case protoreflect.Int32Kind, protoreflect.Sint32Kind, protoreflect.Uint32Kind, protoreflect.Sfixed32Kind, protoreflect.Fixed32Kind:
		g.gf.P("for _, ", f.goName, "Str := range value {")
	...
	case protoreflect.BytesKind:
		g.gf.P("for _, ", f.goName, "Str := range value {")
		g.gf.P(f.goName, " := []byte(", f.goName, "Str)")
