...
func buildExampleServiceNameRPCNameInputMsgName(r *http.Request) (arg *InputMsgName, err error) {
	...
	for key, value := range r.URL.Query() {
		switch key {
		case "int64Argument":
			Int64ArgumentStr := value
			Int64ArgumentValue, convErr := strconv.ParseInt(Int64ArgumentStr[0], 10, 64)
			if convErr != nil {
		...
		case "stringArgument":
			...
			arg.StringArgument = StringArgumentValue[0]
		default:
	...
	for key, value := range r.URL.Query() {
		...
		case "BoolValue":
			...
			case "false", "f", "0":
				...
				arg.BoolValue = BoolValueValue
			default:
				err = fmt.Errorf("unknown bool string value %s", BoolValueStr[0])
				return
			}
		case "EnumValue":
			EnumValueStr := value
			if OptionsValue, optValueOk := Options_value[strings.ToUpper(EnumValueStr[0])]; optValueOk {
				EnumValueOptionsValue := Options(OptionsValue)
				arg.EnumValue = EnumValueOptionsValue
			} else {
				if intOptionValue, convErr := strconv.ParseInt(EnumValueStr[0], 10, 32); convErr == nil {
		...
		case "Int32Value":
			Int32ValueStr := value
			Int32Value, convErr := strconv.ParseInt(Int32ValueStr[0], 10, 32)
			if convErr != nil {
		...
		case "Sint32Value":
			Sint32ValueStr := value
			Sint32Value, convErr := strconv.ParseInt(Sint32ValueStr[0], 10, 32)
			if convErr != nil {
		...
		case "Uint32Value":
			Uint32ValueStr := value
			Uint32Value, convErr := strconv.ParseInt(Uint32ValueStr[0], 10, 32)
			if convErr != nil {
		...
		case "Int64Value":
			Int64ValueStr := value
			Int64ValueValue, convErr := strconv.ParseInt(Int64ValueStr[0], 10, 64)
			if convErr != nil {
		...
		case "Sint64Value":
			Sint64ValueStr := value
			Sint64ValueValue, convErr := strconv.ParseInt(Sint64ValueStr[0], 10, 64)
			if convErr != nil {
		...
		case "Uint64Value":
			Uint64ValueStr := value
			Uint64Value, convErr := strconv.ParseInt(Uint64ValueStr[0], 10, 64)
			if convErr != nil {
		...
		case "Sfixed32Value":
			Sfixed32ValueStr := value
			Sfixed32Value, convErr := strconv.ParseInt(Sfixed32ValueStr[0], 10, 32)
			if convErr != nil {
		...
		case "Fixed32Value":
			Fixed32ValueStr := value
			Fixed32Value, convErr := strconv.ParseInt(Fixed32ValueStr[0], 10, 32)
			if convErr != nil {
		...
		case "FloatValue":
			FloatValueStr := value
			FloatValue, convErr := strconv.ParseFloat(FloatValueStr[0], 32)
			if convErr != nil {
		...
		case "Sfixed64Value":
			Sfixed64ValueStr := value
			Sfixed64ValueValue, convErr := strconv.ParseInt(Sfixed64ValueStr[0], 10, 64)
			if convErr != nil {
		...
		case "Fixed64Value":
			Fixed64ValueStr := value
			Fixed64Value, convErr := strconv.ParseInt(Fixed64ValueStr[0], 10, 64)
			if convErr != nil {
		...
		case "DoubleValue":
			DoubleValueStr := value
			DoubleValueValue, convErr := strconv.ParseFloat(DoubleValueStr[0], 64)
			if convErr != nil {
		...
		case "StringValue":
			StringValueValue := value
			arg.StringValue = StringValueValue[0]
		case "BytesValue":
			arg.BytesValue = []byte(value[0])
		case "MessageValue":
			err = fmt.Errorf("unsupported type message for query argument MessageValue")
			return
		case "SliceStringValue[]":
			arg.SliceStringValue = value
		case "SliceInt32Value[]":
			for _, SliceInt32ValueStr := range value {
...
func buildExampleServiceNameCommonTypesAny(r *http.Request) (arg *anypb.Any, err error) {
	...
	for key, value := range r.URL.Query() {
		...
		case "typeUrl":
			TypeUrlValue := value
			arg.TypeUrl = TypeUrlValue[0]
		case "value":
			arg.Value = []byte(value[0])
		default:
			err = fmt.Errorf("unknown query parameter %s", key)
			return
		}
...
func buildExampleServiceNameCheckRepeatedPathRepeatedCheck(r *http.Request) (arg *RepeatedCheck, err error) {
	...
	for key, value := range r.URL.Query() {
		switch key {
		case "BoolValue[]":
			for _, BoolValueStr := range value {
				switch BoolValueStr {
				case "true", "t", "1":
		...
		case "EnumValue[]":
			for _, EnumValueStr := range value {
		...
		case "Int32Value[]":
			for _, Int32ValueStr := range value {
		...
		case "Sint32Value[]":
			for _, Sint32ValueStr := range value {
		...
		case "Uint32Value[]":
			for _, Uint32ValueStr := range value {
		...
		case "Int64Value[]":
			for _, Int64ValueStr := range value {
		...
		case "Sint64Value[]":
			for _, Sint64ValueStr := range value {
		...
		case "Uint64Value[]":
			for _, Uint64ValueStr := range value {
		...
		case "Sfixed32Value[]":
			for _, Sfixed32ValueStr := range value {
		...
		case "Fixed32Value[]":
			for _, Fixed32ValueStr := range value {
		...
		case "FloatValue[]":
			for _, FloatValueStr := range value {
		...
		case "Sfixed64Value[]":
			for _, Sfixed64ValueStr := range value {
		...
		case "Fixed64Value[]":
			for _, Fixed64ValueStr := range value {
		...
		case "DoubleValue[]":
			for _, DoubleValueStr := range value {
		...
		case "BytesValue[]":
			for _, BytesValueStr := range value {
				BytesValue := []byte(BytesValueStr)
				arg.BytesValue = append(arg.BytesValue, BytesValue)
			}
		case "StringValueQuery[]":
			arg.StringValueQuery = value
		default:
			err = fmt.Errorf("unknown query parameter %s", key)
			return
		}
