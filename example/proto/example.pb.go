...
var file_proto_example_proto_rawDesc = []byte{
	...
	0x70, 0x74, 0x79, 0x2a, 0x20, 0x0a, 0x07, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x09,
	0x0a, 0x05, 0x46, 0x49, 0x52, 0x53, 0x54, 0x10, 0x00, 0x12, 0x0a, 0x0a, 0x06, 0x53, 0x45, 0x43,
	0x4f, 0x4e, 0x44, 0x10, 0x01, 0x32, 0xbb, 0x0d, 0x0a, 0x0b, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x6d, 0x2f, 0x4d, 0x55, 0x6c, 0x74, 0x31, 0x6d, 0x61, 0x74, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x63, 0x2d, 0x67, 0x65, 0x6e, 0x2d, 0x68, 0x74, 0x74, 0x70, 0x67, 0x6f, 0x2f, 0x65, 0x78,
	0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x3b, 0x70, 0x72, 0x6f, 0x74,
...
var file_proto_example_proto_depIdxs = []int32{
	...
	1,  // 5: example.ServiceName.RPCName:input_type -> example.InputMsgName
	2,  // 6: example.ServiceName.AllTypesTest:input_type -> example.AllTypesMsg
	7,  // 7: example.ServiceName.CommonTypes:input_type -> google.protobuf.Any
	8,  // 8: example.ServiceName.Imports:input_type -> somepackage.someCustomMsg1
	1,  // 9: example.ServiceName.sameInputAndOutput:input_type -> example.InputMsgName
	1,  // 10: example.ServiceName.methodWithoutPath:input_type -> example.InputMsgName
	1,  // 11: example.ServiceName.streams:input_type -> example.InputMsgName
	4,  // 12: example.ServiceName.optional:input_type -> example.OptionalField
	1,  // 13: example.ServiceName.GetMethod:input_type -> example.InputMsgName
	5,  // 14: example.ServiceName.CheckRepeatedPath:input_type -> example.RepeatedCheck
	5,  // 15: example.ServiceName.CheckRepeatedQuery:input_type -> example.RepeatedCheck
	5,  // 16: example.ServiceName.CheckRepeatedPost:input_type -> example.RepeatedCheck
	6,  // 17: example.ServiceName.EmptyGet:input_type -> example.Empty
	6,  // 18: example.ServiceName.EmptyPost:input_type -> example.Empty
	3,  // 19: example.ServiceName.RPCName:output_type -> example.OutputMsgName
	2,  // 20: example.ServiceName.AllTypesTest:output_type -> example.AllTypesMsg
	9,  // 21: example.ServiceName.CommonTypes:output_type -> google.protobuf.Empty
	10, // 22: example.ServiceName.Imports:output_type -> somepackage.someCustomMsg2
	3,  // 23: example.ServiceName.sameInputAndOutput:output_type -> example.OutputMsgName
	3,  // 24: example.ServiceName.methodWithoutPath:output_type -> example.OutputMsgName
	3,  // 25: example.ServiceName.streams:output_type -> example.OutputMsgName
	4,  // 26: example.ServiceName.optional:output_type -> example.OptionalField
	3,  // 27: example.ServiceName.GetMethod:output_type -> example.OutputMsgName
	5,  // 28: example.ServiceName.CheckRepeatedPath:output_type -> example.RepeatedCheck
	5,  // 29: example.ServiceName.CheckRepeatedQuery:output_type -> example.RepeatedCheck
	5,  // 30: example.ServiceName.CheckRepeatedPost:output_type -> example.RepeatedCheck
	6,  // 31: example.ServiceName.EmptyGet:output_type -> example.Empty
	6,  // 32: example.ServiceName.EmptyPost:output_type -> example.Empty
