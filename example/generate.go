...
//go:generate protoc -I=. -I=./vendor -I=/usr/local/include -I=./proto --httpgo_out=paths=source_relative,marshaller=easyjson,context=native,library=fasthttp:. proto/example.proto
