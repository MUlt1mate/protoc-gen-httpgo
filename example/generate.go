...
//go:generate protoc -I=. -I=./vendor -I=./proto/somepackage --httpgo_out=. --httpgo_opt=paths=source_relative,marshaller=easyjson proto/example.proto
//go:generate protoc -I=. -I=./vendor -I=./proto/somepackage --httpgo_out=. --httpgo_opt=only=client,paths=source_relative proto/example2.proto
